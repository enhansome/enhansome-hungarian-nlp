...
* [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,872 | 🐛 94 | 🌐 Python | 📅 2026-09-05 👌🚀💯 is a Python NLP Library for Many Human Languages
...
* [Natural-earth-vector](https://github.com/nvkelso/natural-earth-vector) ⭐ 2,199 | 🐛 449 | 🌐 HTML | 📅 2024-04-22 ([`name_hu`](https://github.com/nvkelso/natural-earth-vector/blob/master/packages/Natural_Earth_quick_start/LOCALIZATION.md) ⭐ 2,199 | 🐛 449 | 🌐 HTML | 📅 2024-04-22 imported from wikidata labels)
